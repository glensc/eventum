...
class Issue
{
     ...
     * @var string
     *
     * @ORM\Column(name="iss_impact_analysis", type="text", length=65535, nullable=true)
     */
    private $issImpactAnalysis;
    ...
    /**
     * Set issImpactAnalysis
     *
     * @param string $issImpactAnalysis
     * @return Issue
     */
    public function setIssImpactAnalysis($issImpactAnalysis)
    {
        $this->issImpactAnalysis = $issImpactAnalysis;

        return $this;
    }

    /**
     * Get issImpactAnalysis
     *
     * @return string 
     */
    public function getIssImpactAnalysis()
    {
        return $this->issImpactAnalysis;
    }
